...
const OfficeDetailsPage = () => {
    ...
    useEffect(() => {
        const fetchEquipments = async () => {
            try {
                const res = await fetch(
                    `${VITE_API_URL}/api/office/equipments`,
                    {
                        headers: {
                ...
                toast.error("Error al cargar los equipamientos: ", err);
            }
        };
        ...
        if (office) {
            ...
            setSelectedEquipments(
                new Set(office.equipments.map((eq) => eq.id))
            );
        }
    }, [office, authToken]);
    ...
    const handleUpdateOffice = async (e) => {
        ...
        const formattedOpening =
            opening.length === 5 ? `${opening}:00` : opening;
        const formattedClosing =
            closing.length === 5 ? `${closing}:00` : closing;
    ...
    // Función para mostrar el tipo de espacio en la lengua de Cervantes
                            ...
                            <form onSubmit={handleUpdateOffice}>
                                ...
                                <div className="equipments-list">
                                    ...
                                    {isEditing ? (
                                                        ...
                                                        >
                                                            <label>
                                                                <input
                                                                    ...
                                                                    checked={selectedEquipments.has(
                                                                        equipment.id
                                                                    )}
                                                                />
                                                                {equipment.name}
                                        ...
                                        <div className="equipment-container">
                                            {Array.from(selectedEquipments).map(
                                                (id) => {
                                                    const equipment =
                                                        allEquipments.find(
                                                            (eq) => eq.id === id
                                        ...
                                        <p>
                                            Esta oficina no tiene equipamientos.
                                        </p>
                                    )}
                                </div>
                            </form>
