...
const BookAnOfficePage = () => {
    ...
    if (!oficina) {
        return <div>No existe la oficina.</div>;
    }
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const checkIn = `${checkInDate}T${checkInTime.padStart(
                2,
                "0"
            )}:00:00`;
            const checkOut = `${checkInDate}T${checkOutTime.padStart(
                2,
                "0"
            )}:00:00`;
        ...
        <main className="book-an-office-main">
            <div className="book-an-office-title-container">
                <h1 className="book-an-office-title">
                    Indica los datos de tu reserva
                </h1>
            </div>
