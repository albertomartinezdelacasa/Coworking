    ...
    useEffect(() => {
        ...
        const fetchValidateUser = async () => {
            try {
                ...
                if (!res.ok) {
                    throw new Error(
                        body.message || "Error al activar la cuenta."
                    );
                }
        ...
        return (
            <main className="main-not-active-user">
                <div>
                    ...
                    <p>
                        Seguramente esta cuenta ya está activada o el enlace ha
                        expirado. Por favor, si el problema persiste intenta
    ...
    if (isLoading) {
        return (
            <main className="activate-isloading">
                ...
                <p>
                    Por favor, espera un momento mientras procesamos tu
                    solicitud.
                </p>
            </main>
        );
