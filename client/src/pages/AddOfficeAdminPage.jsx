...
const AddOfficeAdmin = () => {
  ...
  return (
    <main>
      <h2>
        Página de creación de oficinas. SOLO ADMINISTRADOR. SI ERES CLIENTE,
        DISIMULA Y EMPIEZA A ADMINISTRAR
      </h2>
      <form onSubmit={handleAddSpace}>
        ...
        <label htmlFor='workspace'>
          ¿Tiene workspace QUE ES WORKSPACEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE?:{' '}
        </label>
        <select
          id='workspace'
          value={workspace}
